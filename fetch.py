#!/usr/bin/env python3
"""
Recuperation des codes promo Courir depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/courir.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/courir.com"
STORE_NAME = "Courir"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Courir depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-courir)"
    }
    try:
